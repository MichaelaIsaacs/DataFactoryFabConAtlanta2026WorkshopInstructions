...
```
3. Hit **run**. After hitting run, wait for the script to successfully finish; you should see that it succeeded on the bottom UI (left corner). ![alttext](Screenshots/Lab1Photos/16.png)
